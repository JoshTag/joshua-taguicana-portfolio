          ...
          <Fade left>
            <div className="project__info__content">
              ...
              <p className="project__info__content__description">
                Currently, a work in progress project used to teach myself react
                hooks and dive deeper into express. My goal with this project
                was to teach myself hooks by creating a full CRUD application with a back-end.
              </p>
              <div className="project__info__content__links">
                ...
                <a
                  ...
                  href="https://github.com/JoshTag/starwars-database"
                >
                  <svg
                    className="project__info__content__links--live--img"
...
export default ProjectStarwars;
