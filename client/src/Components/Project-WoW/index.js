        ...
        <div className="project__info">
          ...
          <div className="project__info__content">
            ...
            <p className="project__info__content__description">
              ...
              Warcraft make decisions on which items to buy on the auction house
              through graphs which display price and quantity infomation.
            </p>
            <div className="project__info__content__links">
              <a
                ...
                href="https://warcraftauctions.netlify.com/"
              >
                <img className="project__info__content__links--live--img" src={linklogo} alt="Live" />
              </a>
              <a
                className="project__info__content__links--git"
                href="https://github.com/JoshTag/warcraft-auctions"
              >
                <svg className="project__info__content__links--live--img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                  <g fill="#181616">
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
